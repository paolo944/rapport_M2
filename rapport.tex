...
\begin{document}
	...
	\section{MPCitH and SBC signature scheme}
		...
		\begin{itemize}
			...
			\item $w^{\llbracket i \rrbracket}$ is the $i$-th share of w.
			\item $w^[e]$ is a value used in the $e$-th round of the protocol.
			\item $\delta_x$ is the offset for the additive sharing of $x$ s.t. $x = \delta_x + \sum_i x^{\llbracket i \rrbracket}$
		\end{itemize}

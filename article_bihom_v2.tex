...
\begin{document}
	...
	\section{Introduction}
		...
		\begin{definition}
			The Hilbert function of a homogeneous ideal $I = \langle f_1,\dots f_m \rangle$ at degree $s$ is defined as
			$$
		...
		\begin{definition}[Semi-regularity \cite{Bardet04}]
			Let $R = \mathbb{K}[x_1,\dots,x_n]$ a polynomial ring with $\mathbb{K}$ a field.
			A homogeneous sequence $f_1,\dots,f_m \in R$ is semi-regular if the following conditions are verified
			\begin{itemize}
		...
		The Algorithms \ref{alg:crit_calc} will give us the signatures of reductions to 0 during F5-matrix algorithm.
